        ...
        if strategy:
            ...
            if strategy:
                ...
                if np.isnan(profitOfFirst) or profit == profit + profitOfFirst:
                    ...
                    print('Current Profit: ', profit, '€', 'Lenth of Trade:', len(strategy[0]) * 2 * 15,'min' , 'Check:',loadBuy(strategy[0], capacity, poweroutput, load)[2] -loadSell(strategy[0], capacity, poweroutput, load)[2])
